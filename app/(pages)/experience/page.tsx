...
const Experience = async () => {
  ...
  return (
    <Container>
      <AppMotionComponent variant="opacity">
        <div className=" max-w-3xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            when I did my career shift as a web developer, i'll still be doing
            the same... and more?? <span className=" text-2xl"> &#128529;</span>
          </p>
        ...
        <div className="mt-10 grid gap-16 max-w-4xl">
          {experienceList.length > 0 &&
            experienceList.map((exp, idx) => (
              <div
                key={idx}
                className="relative flex flex-col group z-10 gap-2">
